...
internal class VulkanRenderer (val vk: Vk, val resourceFactory: VulkanResourceFactory) : Renderer {
    ...
    private var imageAcquiredSemaphore: Array<Semaphore>? = null
    private var completeRenderSemaphore: Array<Semaphore>? = null
    private var drawingFinishedFence: Array<LongBuffer>? = null
    ...
    fun recreateSwapchain(surface: Surface): Boolean {
        if (swapchainIsDirty) {
            ...
            if (completeRenderSemaphore == null) {
