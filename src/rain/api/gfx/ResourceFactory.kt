...
interface ResourceFactory {
    ...
    fun createMaterial(name: String, vertexShaderFile: String, fragmentShaderFile: String, texture2d: Texture2d?, color: Vector3f, depthWriteEnabled: Boolean = true): Material
    fun createMaterial(name: String, vertexShaderFile: String, fragmentShaderFile: String, texture2d: Array<Texture2d>, color: Vector3f, depthWriteEnabled: Boolean = true): Material
